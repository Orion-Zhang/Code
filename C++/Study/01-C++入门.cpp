...
/**
	C++关键词
		1.C语言共有"32"个关键词，而C++的每套标准关键词数量都可能不同：C++11前共有"63"个关键词，而C++11起共有"73"个关键词，往后标准的关键词数量变化见"3.C++的关键词总览"。
		2.关键词的细节将包含在各个章节中。
...
/**
	"auto"关键词(C++11)
		1.C语言和早期的C++(C++11前)下的"auto"关键词
			a."auto"关键词是一个存储类型说明符，它用于显示地指出变量为自动存储，主要用途是指出当前变量为局部自动变量。
