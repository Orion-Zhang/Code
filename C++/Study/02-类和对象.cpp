...
////拷贝构造函数示例三：编译器自动为类生成的隐式默认拷贝构造函数。
//struct A
//{
//	//构造函数
//	A()
...
////拷贝构造函数示例四：编译器自动为类生成的隐式默认拷贝构造函数，并且类中有指针成员变量。
//struct A
//{
//	A()
//	{
...
////拷贝构造函数示例五：编译器自动为类生成的隐式默认拷贝构造函数，并且类中有指针成员变量，且指针成员变量指向的是堆内存，造成重复释放的错误。(错误示例)
//struct A
//{
//	A()
//	{
