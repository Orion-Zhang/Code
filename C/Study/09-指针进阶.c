...
/**
	指针笔试例题：以下例题请在"x86"环境下的解决方案平台下运行。
*/
...
////指针笔试题例二：在"x86"环境下，已知结构体"Test"类型的变量大小是20个字节，假设"p"的值为"0x100000"，程序输出的结果是什么？
//struct Test
//{
//	int Num;
//	char* pcName;
...
////指针笔试题例三：在"x86"环境下并且是小端存储模式时，程序输出的结果是什么？
//int main()
//{
//	int a[4] = { 1, 2, 3, 4 };
//	int* ptr1 = (int*)(&a + 1);
