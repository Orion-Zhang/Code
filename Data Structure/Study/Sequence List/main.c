...
void Single_SequenceList()
{
	...
	do
	{
		...
		case 1:
		{
			...
			printf("请输入数据>>");
			scanf_s("%d", &val);
			Head_Insert_SequenceList(&List_01, val);
			Clear_Screen();
			break;
		}
		case 2:
		{
			...
			printf("请输入数据>>");
			scanf_s("%d", &val);
			Tail_Insert_SequenceList(&List_01, val);
			Clear_Screen();
			break;
		}
		case 3:
			Head_Delete_SequenceList(&List_01);
			Clear_Screen();
			break;
		case 4:
			Tail_Delete_SequenceList(&List_01);
			Clear_Screen();
			break;
		case 5:
		{
		...
		case 9:
		{
			...
			printf("请输入数据>>");
			scanf_s("%d", &val);
			size_t location = Search_SequenceList_Printf(&List_01, val);
			if (location != 0)
			{
				printf("\n%-s\t%-s\n", "数据元素序号", "数据元素值");
				printf("%-zu\t\t%-d\n\n", location, List_01.array_ptr[location - 1]);
			}
			Clear_Screen();
			break;
		}
		case 10:
			Judge_Empty_SequenceList(&List_01);
			Clear_Screen();
			break;
		case 11:
		{
			...
			printf("请输入位置>>");
			scanf_s("%zu", &location);
			if (Get_Data_SequenceList(&List_01, location, &data))
			{
				printf("\n%-s\t%-s\n", "数据元素序号", "数据元素值");
				printf("%-zu\t\t%-d\n\n", location, data);
			}
